// Section 1, Subcommand 3 (FLANK - Wide Right)
// Wide flanking maneuver from the right

private _playerGrp = group player;
private _targetPos = screenToWorld [0.5, 0.5];

// Calculate wide right flank position (120 degrees right, further distance)
