/*
 * Implementation: fn_flankRight.sqf
 *
...
systemChat format ["Command %1 called by %2", "fn_flankRight.sqf", name _caller];
...
// Calculate flank position to the right
...
hint format ["Flanking RIGHT to grid %1", mapGridPosition _flankPos];
systemChat format ["%1 units flanking right", count _groupUnits];