// AUTO-GENERATED: Mission mode enabled
#define __MISSION_MODE__

// Include path configuration (mission vs mod mode)
#include "paths.hpp"
...
// DIALOG DEFINITIONS
// ============================================================================
#include PATH_UI"BaseControls.hpp"
...
class Extended_PreInit_EventHandlers {
    class CMDWHEEL {
        init = "call compile preprocessFileLineNumbers '" PATH_PREFIX "XEH_preInit.sqf'";
    };
};
